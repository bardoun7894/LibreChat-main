...
# AI SaaS Platform Docker Development Script
...
check_health() {
    ...
    services=("mongodb" "redis" "api-gateway" "user-management" "chat" "image-generation" "video-generation" "audio" "code-generation" "design-analysis" "mcp" "workflow" "billing" "storage" "client" "nginx")
...
show_urls() {
    ...
    echo "Image Generation: http://localhost:3003"
    echo "Video Generation: http://localhost:3004"
    echo "Audio: http://localhost:3005"
    echo "Code Generation: http://localhost:3006"
    echo "Design Analysis: http://localhost:3007"
    echo "MCP: http://localhost:3008"
    echo "Workflow: http://localhost:3009"
    echo "Billing: http://localhost:3010"
    echo "Storage: http://localhost:3011"
}
...
case "$1" in
    ...
    "urls")
        ...
        ;;
    *)
        echo "AI SaaS Platform Docker Development Script"
        echo ""
